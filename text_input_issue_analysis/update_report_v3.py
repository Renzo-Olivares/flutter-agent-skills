...
# update counters
content = re.sub(r'Processed: \d+ \/ 44', 'Processed: 9 / 44', content)
content = re.sub(r'Tests written: \d+', 'Tests written: 1', content)
content = re.sub(r'Failed as expected: \d+', 'Failed as expected: 1', content)
content = re.sub(r'Duplicate clusters \(tentative\): \d+', 'Duplicate clusters (tentative): 1 (TRL-SPC-1)', content)
